...
<div class="center-block" style="padding: 50px 50px 5px;left:37%;background-color: white; margin-top:10px;width:500px;height:280px;position:absolute;border-radius: 30px;">
    <form class="bs-example bs-example-form" role="form" name="input" id="input" style="position:absolute;left:50px;top:0px;width:400px;height:325px;">
        ...
        <br>
        <div class="input-group">
            <div style="position:absolute;left:0px;margin-top: 110px">
                <input type="button"  class="btn btn-primary" value="登录" onclick="return signin();">
            </div>
        </div>
        <br>
        <div class="input-group">
            <div style="position:absolute;left:170px;margin-top: 150px;width:300px">
                <span>没有账号?</span><br>
                <a href="/web_project/index.php/user/signup" style="color:green">创建账号</a>
            </div>
        </div>
    </form>
</div>
